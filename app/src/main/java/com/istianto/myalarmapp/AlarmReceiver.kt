...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        //sipkan 2 ID Untuk 2 macam alarm, one time dan repeating
    ...
    private fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int) {
        val channelId = "chanel_1"
        val channelName = "AlarmManager chanel1"
        ...
        val notfication = builder.build()
        notificationManagerCompat.notify(notifId, notfication)
    }
    ...
    fun setOneTimeAlarm(context: Context, type: Int, date: String, time: String, message: String) {
        ...
        Toast.makeText(context,"Sucsess Set Up Time One Alarm", Toast.LENGTH_SHORT).show()
    ...
    fun cancleAlarm (context: Context, type: Int) {
        ...
        val requestCode = when (type) {
            ...
            else -> Log.i ("cancleAlarm", "cancleAlarm: Unknow type of Alarm")
        }
        ...
        if (type == TYPE_ONE_TIME) {
            Toast.makeText(context, "Cancle One Time Alarm", Toast.LENGTH_SHORT).show()
        } else {
            Toast.makeText(context, "Cancle Repeating Alarm", Toast.LENGTH_SHORT).show()
        }
    }

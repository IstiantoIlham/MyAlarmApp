package com.istianto.myalarmapp.adapter
...
import com.istianto.myalarmapp.R
...
class AlarmAdapter() :
    ...
    fun setData (list : List<Alarm>) {
        ...
        val alaraDiffUtilResult = DiffUtil.calculateDiff(alarmDiffUtil)
        this.alarms = list

        alaraDiffUtilResult.dispatchUpdatesTo(this)
